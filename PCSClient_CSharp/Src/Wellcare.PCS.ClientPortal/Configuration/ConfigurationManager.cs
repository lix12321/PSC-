...
namespace Wellcare.PCS.ClientPortal.Configuration
{
    ...
    {
        private const string ApplicationConfigFileName = "ConfigClientPortal.json";
        ...
        {
            var fileName = Path.Combine(Path.GetDirectoryName(Directory.GetParent(this.GetType().Assembly.Location).FullName), ApplicationConfigFileName);
