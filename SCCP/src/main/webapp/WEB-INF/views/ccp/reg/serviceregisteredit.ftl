					...
					<div class="fluidbox">
						<p class="p6 p-item">
							...
							<input type="text" id="orgName" name="transCode"
								class="txt w200 easyui-validatebox" value="${(obj.transCode)!}" readonly
							...
							<label class="lab-item"><font class="red">*</font>系统服务号: </label>
							  <select class="txt w200 easyui-validatebox" name="serverCode" id="serverCode">
							 	<#list serverCodeList as sc>
							 		<option value="${(sc.serverCode)!}" <#if obj.serverCode == sc.serverCode> selected </#if>>${(sc.serverName)!}</option>
							 	</#list>
							 </select>
						</p>
                        <p class="p12 p-item">
                        ...
                        <p class="p6 p-item">
                            ...
                            <input type="text" id="orgIndex" name="requestMethod"
                                   class="txt w200 easyui-validatebox" value="${(obj.requestMethod)!}"
                                   data-options="required:true,validType:'length[2,40]'" />
                        </p>
                        <p class="p6 p-item">
                            <label class="lab-item"><font class="red"></font>请求端口: </label>
                            <input type="text" id="orgIndex" name="requestPort" 
                                   class="txt w200 easyui-numberbox" value="${(obj.requestPort)!}"
                                   data-options="required:true,validType:'length[2,40]'" />
                        </p>
                        <p class="p6 p-item">
                            <label class="lab-item"><font class="red"></font>请求类型: </label>
                            <@cont.select class="txt w200 easyui-validatebox" name="requestType"
                            	value="${(obj.requestType)!}" id="requestType" codeDiv="REQUEST_TYPE" />
                        </p>
                        <p class="p6 p-item">
                            <label class="lab-item"><font class="red"></font>超时时间: </label>
                            <input type="text" id="orgIndex" name="timeOut"
                                   class="txt w200 easyui-validatebox" value="${(obj.timeOut)!}"
                                   data-options="required:true,validType:'length[2,40]'" />
                        </p>
                        	<p class="p6 p-item">
							<label class="lab-item"><font class="red">*</font>是否缓存: </label>
                            <@cont.select class="txt w200 easyui-validatebox" 
                            	value="${(obj.cache)!}"
                            	name="cache" id="cache" codeDiv="YES_NO" />
						</p>
						<p class="p6 p-item">
							<label class="lab-item"><font class="red">*</font>缓存时间: </label>
							<input type="text" id="pyCode" name="cacheDuration"
								class="txt w200 easyui-numberbox" value="${(obj.cacheDuration)!}"
                        ...
                        <p class="p6 p-item">
                            ...
                            <@cont.select class="txt w200 easyui-validatebox" name="dataType"
                            	value="${(obj.dataType)!}" id="dataType" codeDiv="DATA_TYPE" />
                        </p>
                        <p class="p6 p-item">
                            <label class="lab-item"><font class="red"></font>是否启用: </label>
                            <@cont.select class="txt w200 easyui-validatebox" 
                            	value="${(obj.enable)!}" name="enable" id="enable" value="1" codeDiv="ENABLE" />
                        </p>
					</div>
