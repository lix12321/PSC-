...
@Controller
@RequestMapping("monthorderrefundrate")
public class MonthOrderRefundRateController {

	@Resource
	private IMonthOrderRefundRateService iMonthOrderRefundRateService;
	...
	public String index(HttpServletRequest request, ModelMap dataMap) throws Exception {
		return "statistics/monthorderrefundrate";
	}
	...
	public Map<String, Object> getChartData(HttpServletRequest request){
		...
		Map<String, Object> dataMap = iMonthOrderRefundRateService.getChartData(queryMap);
		return dataMap;
	}
}
