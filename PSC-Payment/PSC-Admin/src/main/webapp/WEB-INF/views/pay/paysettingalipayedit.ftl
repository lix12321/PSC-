                        ...
                        <div class="fluidbox">
                            <p class="p12 p-item">
                                <label class="lab-item"><font class="red">*</font>合作身份者ID:
                                                ...
                                                data-options="required:true,validType:'length[2,20]'" value="${obj.partner}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                        ...
                        <div class="fluidbox">
                            <p class="p12 p-item">
                                <label class="lab-item"><font class="red">*</font>收款账号:
                                                ...
                                                data-options="required:true,validType:'length[2,20]'" value="${obj.sellerEmail}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                        ...
                        <div class="fluidbox">
                            <p class="p12 p-item">
                                <label class="lab-item"><font class="red">*</font>商户的私钥:
                                                ...
                                                data-options="required:true,validType:'length[16,20000]'" value="${obj.key}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                        ...
                        <div class="fluidbox">
                            <p class="p12 p-item">
                                <label class="lab-item"><font class="red">*</font>字符编码格式:
                                                ...
                                                data-options="required:true,validType:'length[2,20]'" value="${obj.inputCharset}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                        ...
                        <div class="fluidbox">
                            <p class="p6 p-item">
                                <label class="lab-item"><font class="red">*</font>签名方式:
                                                ...
                                                data-options="required:true,validType:'length[2,20]'" value="${obj.signType}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                        ...
                        <div class="fluidbox">
                            <p class="p6 p-item">
                                <label class="lab-item"><font class="red">*</font>交易超时时间:
                                                ...
                                                data-options="required:true,validType:'length[1,20]'" value="${obj.timeout}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                        ...
                        <div class="fluidbox">
                            <p class="p6 p-item">
                                <label class="lab-item"><font class="red">*</font>支付宝网关名:
                                                ...
                                                data-options="required:true,validType:'length[1,40]'" value="${obj.openApiDomain}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                        ...
                        <div class="fluidbox">
                            <p class="p6 p-item">
                                <label class="lab-item"><font class="red">*</font>监控地址域名:
                                                ...
                                                data-options="required:true,validType:'length[1,40]'" value="${obj.mcloudApiDomain}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                        ...
                        <div class="fluidbox">
                            <p class="p6 p-item">
                                ...
                                <input type="text" id="pid" name="pid"
                                       ...
                                       data-options="required:true,validType:'length[2,40]'" value="${obj.pid}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                        ...
                        <div class="fluidbox">
                            ...
                            <p class="p6 p-item">
                                <label class="lab-item"><font class="red">*</font>appid:
                                                ...
                                                class="txt w550 easyui-validatebox"
                                                data-options="required:true,validType:'length[2,40]'" value="${obj.appid}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                        ...
                        <div class="fluidbox">
                            <p class="p6 p-item">
                                <label class="lab-item"><font class="red">*</font>RSA私钥:
                                                ...
                                                data-options="required:true,validType:'length[16,20000]'" value="${obj.privateKey}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                        ...
                        <div class="fluidbox">
                            <p class="p6 p-item">
                                <label class="lab-item"><font class="red">*</font>公钥:
                                                ...
                                                data-options="required:true,validType:'length[16,20000]'" value="${obj.publicKey}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                                    style="color: #808080">支付宝公钥，使用支付宝签名工具生成</font>
                            </label>
                            </p>
                        </div>
                        <div class="fluidbox">
							<p class="p6 p-item">
								<label class="lab-item"><font class="red">*</font>支付宝公钥:
									...
									class="txt w550 easyui-validatebox" value="${(obj.alipayPublicKey)!}"
									missingMessage="支付宝公钥必填，2-20个字符"
                        ...
                        <div class="fluidbox">
                            <p class="p6 p-item">
                                <label class="lab-item"><font class="red">*</font>最大查询次数:
                                                ...
                                                data-options="required:true,validType:'length[1,40]'" value="${obj.maxQueryRetry}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                        ...
                        <div class="fluidbox">
                            <p class="p6 p-item">
                                <label class="lab-item"><font class="red">*</font>当面付最大查询延迟:
                                                ...
                                                data-options="required:true,validType:'length[1,40]'" value="${obj.queryDuration}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                        ...
                        <div class="fluidbox">
                            <p class="p6 p-item">
                                <label class="lab-item"><font class="red">*</font>最大撤销次数:
                                                ...
                                                data-options="required:true,validType:'length[1,40]'" value="${obj.maxCancelRetry}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                        ...
                        <div class="fluidbox">
                            <p class="p6 p-item">
                                <label class="lab-item"><font class="red">*</font>最大撤销次数和撤销延迟:
                                                ...
                                                data-options="required:true,validType:'length[1,40]'" value="${obj.cancelDuration}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                                    style="color: #808080">当面付最大撤销次数和撤销间隔（毫秒）</font>
                        ...
                        <div class="fluidbox">
                            <p class="p6 p-item">
                                <label class="lab-item"><font class="red">*</font>第一次调度延迟和调度间隔:
                                                ...
                                                data-options="required:true,validType:'length[1,40]'" value="${obj.heartbeatDelay}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
                        ...
                        <div class="fluidbox">
                            <p class="p6 p-item">
                                <label class="lab-item"><font class="red">*</font>第一次调度延迟和调度延迟:
                                                ...
                                                data-options="required:true,validType:'length[1,40]'" value="${obj.heartbeatDuration}"/>
                            </p>
                            <p class="p12 p-item">
                                <label class="lab-item">&nbsp;</label> <label> <font
