...
@Controller
public class UnifyPaymentController extends BaseController {
	...
	@ResponseBody
	public ServiceResult<PaymentResult> unifyPay(HttpServletRequest request, HttpServletResponse response,
