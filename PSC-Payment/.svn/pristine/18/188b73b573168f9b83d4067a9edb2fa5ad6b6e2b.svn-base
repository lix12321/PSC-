...
<script>
	function dosubmit(obj) {
        ...
        $.ajax({
            url:'demo/unifyPayAccount/doAccpay',
            type : 'post',
        ...
        $.ajax({
            url:'demo/view/getAccAmount?userId='+userid,
            async: true,
            success:function(data){
                $(".accountinfo").html("当前余额："+data);
            }
        });
