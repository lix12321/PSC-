...
public class CodeManager {
	...
	private static ISysCodeMasterService codeService;

	public static void setCodeService(ISysCodeMasterService codeService) {
	...
	public static void init() {
		...
		RpcResult<List<SysCodeMaster>> serviceResult = codeService.page(map, null);
